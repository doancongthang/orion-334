                    ...
                    try
                    {
                        switch (boardId)
                        {
                            case 1:
                                ...
                                modbusClient.WriteSingleCoil(13, mc1.sig_count_rotate);
                                modbusClient.WriteSingleCoil(14, mc1.sig_starting_forbidden);
                                modbusClient.WriteSingleCoil(15, mc1.sig_upper_oil);
                                modbusClient.WriteSingleCoil(16, mc1.sig_oil_supply);
                                modbusClient.WriteSingleCoil(17, mc1.sig_vvd);
                                modbusClient.WriteSingleCoil(18, mc1.sig_vvd);
                                modbusClient.WriteSingleCoil(19, mc1.sig_mpa);
                                modbusClient.WriteSingleCoil(20, mc1.sig_pumping_MPA);
                                modbusClient.WriteSingleCoil(21, mc1.sig_pumping_MPA);
                                modbusClient.WriteSingleCoil(22, mc1.sig_pumping_MPA);
                                modbusClient.WriteSingleCoil(23, mc1.sig_oil_no_pump);
                                modbusClient.WriteSingleCoil(24, mc1.sig_oil_no_pump);
                                modbusClient.WriteSingleCoil(25, mc1.sig_oil_no_pump);
                                modbusClient.WriteSingleCoil(26, mc1.sig_pumping_MPA);
                                modbusClient.WriteSingleCoil(27, mc1.sig_pumping_MPA);
                            ...
                            case 2:
                                ...
                                modbusClient.WriteSingleCoil(2, mc2.sig_phi_s3);
                                modbusClient.WriteSingleCoil(3, mc2.sig_phi_s2);
                                modbusClient.WriteSingleCoil(4, mc2.sig_phi_s1);
                                modbusClient.WriteSingleCoil(5, mc2.sig_protect_on);
                                modbusClient.WriteSingleCoil(6, mc2.sig_temperature_water);
                                modbusClient.WriteSingleCoil(7, mc2.sig_pressure_water);
                                modbusClient.WriteSingleCoil(8, mc2.sig_temperature_oil);
                                modbusClient.WriteSingleCoil(9, mc2.sig_pressure_oil);
                                modbusClient.WriteSingleCoil(10, mc2.sig_park);
                                modbusClient.WriteSingleCoil(11, mc2.sig_goahead);
                                modbusClient.WriteSingleCoil(12, mc2.sig_goahead);
                                modbusClient.WriteSingleCoil(13, mc2.sig_goahead);
                                modbusClient.WriteSingleCoil(14, mc2.sig_highspeed);
                                modbusClient.WriteSingleCoil(15, mc2.sig_highspeed);
                                modbusClient.WriteSingleCoil(16, mc2.sig_highspeed);
                                modbusClient.WriteSingleCoil(17, mc2.sig_nopressure);
                                modbusClient.WriteSingleCoil(18, mc2.sig_nopressure);
                                modbusClient.WriteSingleCoil(19, mc2.sig_nopressure);
                                ...
                                modbusClient.WriteSingleCoil(25, mc2.sig_protect_on);
                                modbusClient.WriteSingleCoil(26, mc2.sig_temperature_oil);
                                modbusClient.WriteSingleCoil(27, mc2.sig_pressure_water);
                                modbusClient.WriteSingleCoil(28, mc2.sig_temperature_oil);
                                modbusClient.WriteSingleCoil(29, mc2.sig_pressure_oil);
                                break;
                            case 3:
                                modbusClient.UnitIdentifier = 3;
                                ...
                                modbusClient.WriteSingleCoil(2, mc3.sig_pressure_oil);
                                modbusClient.WriteSingleCoil(3, mc3.sig_temperature_oil);
                                modbusClient.WriteSingleCoil(4, mc3.sig_pressure_water);
                                modbusClient.WriteSingleCoil(5, mc3.sig_temperature_water);
                                modbusClient.WriteSingleCoil(6, mc3.sig_protect_on);
                                modbusClient.WriteSingleCoil(7, mc3.sig_phi_s1);
                                modbusClient.WriteSingleCoil(8, mc3.sig_phi_s2);
                                modbusClient.WriteSingleCoil(9, mc3.sig_phi_s3);
                                ...
                                modbusClient.WriteSingleCoil(25, mc3.sig_park);
                                modbusClient.WriteSingleCoil(26, mc3.sig_park);
                                modbusClient.WriteSingleCoil(27, mc3.sig_gobehind);
                                modbusClient.WriteSingleCoil(28, mc3.sig_gobehind);
